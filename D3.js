...
let operzione = Math.floor (Math.random()*starWarsCharacters.length)
console.log (starWarsCharacters[operzione].name)
console.log (starWarsCharacters[operzione].eye_color)